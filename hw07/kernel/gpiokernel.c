...
static unsigned int gpioLED = 115;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 113;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
